...
DB_PATH = Path(__file__).parent / "instance" / "hospital.db"
...
PATIENTS = [
    ...
    ("Aditya Varma", 42, "Male", "9934567892", "23 Lotus Lane, Nagpur"),
    ...
    ("Kunal Chopra", 52, "Male", "9912345670", "344 Lotus Street, Patna"),
    ("Ritu Agarwal", 35, "Female", "9923456781", "12 Palm Grove, Chandigarh"), 
]
